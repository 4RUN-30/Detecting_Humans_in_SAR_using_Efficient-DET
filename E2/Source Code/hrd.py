...
class WindowClass(QMainWindow, form_class) :
    def __init__(self):
        ...
        self.slicepath = "/home/bharath.k@zucisystems.com/Documents/Object_Detection_Drone-master/ui_test"
    ...
    def btn_videoslice(self):
        ...
        while success:
            cv2.imwrite("/home/bharath.k@zucisystems.com/Documents/Object_Detection_Drone-master/ui_test/%d.jpg" % count, image)
            success,image = vidcap.read()
    ...
    def btn_yolo(self):
        ...
        self.textBrowser_2.append("Go to /home/bharath.k@zucisystems.com/Documents/Object_Detection_Drone-master/ui_test")
        # self.work.start()
        fname = QFileDialog.getOpenFileName(self)
...
if __name__ == "__main__" :
    ...
    os.system('python detect_result.py --source data/5.mp4 --weights weights/drone_survivor.pt --classes 0 --project ui_test --img 3840')
